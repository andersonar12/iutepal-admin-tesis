		...
		<div class = "container-fluid">
			<div class = "col-md-2 well" style = "margin-top:80px;">
				<div class = "container-fluid" style = "word-wrap:break-word;">
					<img src = "images/user.png" style="display:none" width = "50px" height = "50px"/>
					<br />
					<br />
				</div>
				...
				<ul id = "menu" class = "nav menu">
					...
					<li><a style = "font-size:13px; border-bottom:1px solid #d3d3d3;" href = "login.php"><i class = "glyphicon glyphicon-edit"></i> Gestion de Trabajos de Grado</a></li>
						...
						<div class = "col-lg-6">
							<form method = "POST" action = "save_book_query.php" enctype = "multipart/form-data">
								...
								<div class = "form-group">
                                   ...
                                   <input type = "text" name = "date_publish" required = "required" class = "form-control" autocomplete="off"/>
