		...
		<div class = "container-fluid">
			<div class = "col-md-2 well" style = "margin-top:80px;">
				<div class = "container-fluid" style = "word-wrap:break-word;">
					<img src = "images/1499426760457_1.jpg" width = "95px" height = "95px"/>
					<br />
					<br />
					<label class = "text-muted">Prof. <?php require'account2.php'; echo $name;?></label>
				</div>
				<hr style = "border:1px dotted #d3d3d3;"/>
				<ul id = "menu" class = "nav menu">
				
					<li><a style = "font-size:18px; border-bottom:1px solid #d3d3d3;" href = "profesor.php"><i class = "glyphicon glyphicon-book"></i>  Trabajos de Grado</a></li>
			...
			<div class = "col-md-10 well" style = "margin-top:80px;">
				<div class = "alert alert-info">MODULO PROFESORES</div>
						...
						<table id = "table" class = "table table-bordered">
							...
							<tbody>
								...
								<tr>
									...
									<td align="justify"><!--<a class = "btn btn-danger deltesis_id" value = "<?php echo $fbook['tesis_id']?>">> <span class = "glyphicon glyphicon-remove"></span> Eliminar</a> --> <a value = "<?php echo $fbook['tesis_id']?>" class = "btn btn-warning etesis_id"><span class = "glyphicon glyphicon-edit"></span> Editar</a></td>
								</tr>
								<?php
									}
								?>
					...
					<div id = "book_form" style = "display:none;">
						...
						<div class = "col-lg-6">
							<form method = "POST" action = "save_book_query2.php" enctype = "multipart/form-data">
