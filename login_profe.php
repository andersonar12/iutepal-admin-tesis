...
Sistema para la Consulta de Trabajos Especiales de Grado del I.U.T.E.P.A.L</h4>
		...
		<div class = "container-fluid" style = "margin-top:80px;">
			<div class = "col-md-3" style="background-image:url(images/Presentaci%C3%B3n1.png);margin-left:10px;" >
				<br />
				<br />
				<h4 style="font-size:18px">Estas intentado acceder al modulo de Profesores:</h4>
				...
				<ul id = "menu" class = "nav menu">
				    <li><a style = "font-size:18px; border-bottom:1px solid #d3d3d3;" href = "home.php"><i class = "glyphicon glyphicon-log-out"></i> Ir a Gestion Adminitrativa</a></li>
        ...
        <br />
			...
			<div class = "col-md-8 well" style="margin-left:10px;">
				<img src = "images/back2.jpg" height = "449px" width = "100%" />
			</div>
		</div>
