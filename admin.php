						...
						<table id = "table" class = "table table-bordered">
							...
							?>	
								<tr class = "target">
									...
									<td><button type="button" class = "btn btn-danger deladmin_id" value = "<?php echo $f_admin['admin_id']?>"><span class = "glyphicon glyphicon-remove"></span> Eliminar</button> <a href = "#" class = "btn btn-warning eadmin_id" value = "<?php echo $f_admin['admin_id']?>"><span class = "glyphicon glyphicon-edit"></span> Editar</a></td>
								</tr>
							<?php
								}
							?>	
