		...
		<div class = "container-fluid">
			<div class = "col-md-2 well" style = "margin-top:80px;">
				<div class = "container-fluid" style = "word-wrap:break-word;">
					<img src = "images/carreras/electronica.png"  width = "80px" height = "80px"/>
			...
			<div class = "col-md-10 well" style = "margin-top:80px;">
				<div class = "alert alert-info">ELECTRONICA INDUSTRIAL</div>
					...
					<div id = "book_table">
						<table id = "table" class = "table table-bordered">
							...
							<tbody>
								<?php
									$qbook = $conn->query("SELECT * FROM tesis WHERE carrera='Electronica Industrial'") or die(mysqli_error());
